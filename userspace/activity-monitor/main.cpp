...
/*
 * Activity Monitor — temporary wm+kilim smoke stub (legacy gfx UI removed).
 */
...
extern "C" void exec_main(void)
{
    ...
    for (;;) {
        ...
        k.fill_rect(20, 20, 340, 48, kilim::rgba(40, 40, 50, 255));
        k.text("Activity Monitor (wm+kilim stub)", 28, 32, 16,
