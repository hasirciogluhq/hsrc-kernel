#ifndef HSRC_KERNEL_DX_API_H
#define HSRC_KERNEL_DX_API_H

#include <kernel/types.h>

/*
 * Thin ABI between kernel core (syscalls) and dx.kmod.
 * dx registers this table from kmod_init; core never links gfx objects.
 */
typedef struct dx_api {
